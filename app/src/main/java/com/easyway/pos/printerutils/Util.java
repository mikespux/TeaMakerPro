...
public class Util {
    ...
    public static String getHHMM(String time) {
        ...
        String MM = finalTime.substring(finalTime.indexOf(":") + 1, finalTime
                .indexOf(" "));
        String AMPM = finalTime.substring(finalTime.indexOf(" "));
     ...
     * @param cpl    number of characters
     ...
     *
     * @param item   String to be aligned
     ...
     *
     * @param item   String to be allign
     * @param digits number of characters
