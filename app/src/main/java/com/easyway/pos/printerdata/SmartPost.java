package com.easyway.pos.printerdata;
...
public class SmartPost {
    ...
    // ������������ID,������������������������������
    // ������������������EMV POS��������ID��������
    private static final byte[] id = new byte[]{0, 0, 0, 0, 0, 1}; // "000001";//6������
    private static final String business_en = ""; // ���������� LLVAR60_2
    private static final String business_zh = ""; // ���������� LLVAR60
    private static final String businessNo = "123456789012345"; // ������ AN15
    private static final String terminalNo = "12345678"; // ������ AN8
